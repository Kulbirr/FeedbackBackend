...
//                System.out.println("Role extracted from JWT: " + role); // Debug log

//                checking if role extracted properly
                if (role == null) {
                    throw new BadCredentialsException("Role is missing or invalid in the token");
                }
